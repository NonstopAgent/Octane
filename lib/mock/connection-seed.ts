  ...
  return [
    {
      ...
      description: "Read-only repo status via server GITHUB_TOKEN.",
      metadata: { hint: "Set GITHUB_TOKEN in deployment env" },
      createdAt: T,
      updatedAt: T,
    },
    {
      ...
      label: "Vercel",
      status: "not_connected",
      description: "Read-only deployments via server VERCEL_TOKEN.",
      metadata: { hint: "Set VERCEL_TOKEN (+ optional VERCEL_TEAM_ID)" },
      createdAt: T,
      updatedAt: T,
    },
    {
