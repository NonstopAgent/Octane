...
export function AppSidebar() {
  return (
    <>
      <aside className="hidden h-[calc(100vh-4rem)] w-64 shrink-0 border-r border-zinc-800/80 bg-zinc-950/70 p-4 md:block">
      ...
      <div className="md:hidden">
        <Sheet>
          ...
          <SheetContent side="left" className="border-zinc-800 bg-zinc-950 p-4">
            <div className="mb-4 px-2">
              <p className="text-xs uppercase tracking-[0.2em] text-zinc-400">Octane Core</p>
              <p className="text-lg font-semibold text-zinc-100">Command Center</p>
            </div>
